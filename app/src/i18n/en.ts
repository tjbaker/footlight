...
export const en: Messages = {
  ...
  settings: {
    menuLabel: "Settings",
    title: "Settings",
    apiKeySection: "AI subject tracking (Gemini)",
    apiKeyLabel: "API key",
    apiKeyPlaceholder: "Gemini API key (BYOK)",
    apiKeyHint:
      "Bring your own key. Stored locally on this device (localStorage); it is sent only to Google's API when you run Auto-track, and never anywhere else. Auto-track is entirely optional — leave this blank if you don't use it.",
    close: "Close",
  },
};
