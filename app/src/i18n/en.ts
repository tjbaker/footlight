...
export const en: Messages = {
  ...
  settings: {
    ...
    rendering: {
      ...
      captionStyleNote:
        "The hook sits above the title; position comes from the clip.",
      captionStyle: "Caption style",
      captionStyleAppliesHint: "Applies when captions are burned on.",
      captionColor: "Fill color",
      captionOutlineColor: "Outline color",
      captionEmphasis: "Emphasis",
      captionBold: "Bold",
      captionItalic: "Italic",
      captionUnderline: "Underline",
      captionBoldGlyph: "B",
      captionItalicGlyph: "I",
      captionUnderlineGlyph: "U",
      captionEffects: "Effects",
      captionShadow: "Drop shadow",
      captionBox: "Box",
